...
urlpatterns = [
    ...
    path("attendance_report/", StaffViews.generate_attendance_report, name="attendance_report"),
    path("download_attendance_report/", StaffViews.download_attendance_report, name="download_attendance_report"),
